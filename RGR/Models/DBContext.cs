...
namespace RGR.Models
{
    public class DBContext
    {
        ...
        {
            SQLiteCommand command = new(query, sql_con);
        ...
        public void Save(DataSet sTables)
        {
            ...
            {
                SQLiteDataAdapter adapter = new("select * from " + table.TableName, sql_con);
        ...
        private DBContext()
        {
            ...
            sql_con = new SQLiteConnection("Data Source=FootballNTDB.db;Mode=ReadWrite");
            sql_con.Open();
